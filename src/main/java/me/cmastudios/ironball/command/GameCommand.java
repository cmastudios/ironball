    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        switch (option) {
            case START:
                ...
                plugin.getServer().broadcast(IronBall.getPrefix() + IronBall.getString("GAME.ANNOUNCE",
                    new Object[]{sender.getName(), arena.getName(), Game.MIN_PLAYERS}), "ironball.play." + arena.getName());
                break;
            case PLAY:
                if (player == null) {
